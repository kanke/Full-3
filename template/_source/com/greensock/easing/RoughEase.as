...
class com.greensock.easing.RoughEase {
		 ...
		 */
		public function RoughEase(strength:Number, points:Number, restrictMaxAndMin:Boolean, templateEase:Function, name:String) {
		 ...
		 */
		public static function create(strength:Number, points:Number, restrictMaxAndMin:Boolean, templateEase:Function, name:String):Function {
